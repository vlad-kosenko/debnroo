...
class MDN_ProductReturn_AdminController extends Mage_Adminhtml_Controller_Action {
        ...
        try {
            ...
            if (!$isCreation) {
                ...
                /*
                  ...
                  echo "\n".'#################################'."\n";
                  echo "\n Creditmemo creation data : "."\n";
                  var_dump($this->_CreditMemoCreationData);
                  echo '</pre>';
                  die('');
                  */
    ...
    private function initDataCreditMemo($rma) {
        ...
        $this->_CreditMemoCreationData['refund'] = $data['credit_memo_refund'];
        $this->_CreditMemoCreationData['fee'] = $data['credit_memo_fee'];
